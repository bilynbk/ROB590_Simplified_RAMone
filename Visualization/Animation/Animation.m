...
a10 = text(0.8*boarderL,0.1*boarderT,['' ...
    num2str(T(1),'%1.1f') ' sec'],'color','k');

% Display states on plot
a11 = text(0.8*boarderL,0.9*boarderT,'\fontsize{10}\fontname{Arial Black}Flight','color',[0.8,0.8,0.8]);
a12 = text(0.8*boarderL,0.8*boarderT,'\fontsize{10}\fontname{Arial Black}Compression','color',[0.8,0.8,0.8]);
a13 = text(0.8*boarderL,0.7*boarderT,'\fontsize{10}\fontname{Arial Black}Thrust','color',[0.8,0.8,0.8]);
a14 = text(0.7*boarderL,0.6*boarderT,'\fontsize{10}\fontname{Arial Black}R','color',[0.8,0.8,0.8]);
a15 = text(0.8*boarderL,0.6*boarderT,'\fontsize{10}\fontname{Arial Black}L','color',[0.8,0.8,0.8]);       
